...
public class PhidgetsInterfaceBoard2 {

    private static Logger log = Logger.getLogger(PhidgetsInterfaceBoard2.class);
    ...
    public PhidgetsInterfaceBoard2() throws Exception {
        init();
    }
